...
public interface WwithusEntryRepository extends JpaRepository<WwithusEntry, String>
{
	 ...
	 *         {@link withus.entity.WwithusEntry#getCode()}가 {@code not}이 아니며
	...
	/**
	 * {@link withus.repository.WwithusEntryRepository#findAllByAnswerIsTrueAndCodeIsNotAndCodeStartsWithOrderByCode(String, String)}를
	...
	/**
	 * {@link withus.repository.WwithusEntryRepository#findTopByCodeStartsWithAndFirstIsTrueOrderByCode(String)}를
