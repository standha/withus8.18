...
public class AlarmController extends BaseController
{
	...
	@Autowired
	public AlarmController(AuthenticationFacade authenticationFacade, UserService userService,
	...
	public Result<Tbl_medication_alarm> postMedicationAlarm(@RequestBody Tbl_medication_alarm tbl_medication_alarm)
	{
		...
		return Result.<Tbl_medication_alarm>builder().setCode(code).setData(seved).createResult();
	}

	@GetMapping("/appointments")
	@Statistical
	public ModelAndView getAppointments(@RequestParam(required = false) Integer year,
	...
	@ResponseBody
	public Result<Tbl_outpatient_visit_alarm> PostPatientVisit(
			@RequestBody Tbl_outpatient_visit_alarm tbl_outpatient_visit_alarm)
	{
		String userId = getUsername();
		...
		return Result.<Tbl_outpatient_visit_alarm>builder().setCode(code).setData(seved).createResult();
	}
}