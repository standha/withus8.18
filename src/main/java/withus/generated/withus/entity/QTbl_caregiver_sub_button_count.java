...
/**
 * QTbl_caregiver_sub_button_count is a Querydsl query type for Tbl_caregiver_sub_button_count
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QTbl_caregiver_sub_button_count extends EntityPathBase<Tbl_caregiver_sub_button_count> {

    private static final long serialVersionUID = -946577710L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QTbl_caregiver_sub_button_count tbl_caregiver_sub_button_count = new QTbl_caregiver_sub_button_count("tbl_caregiver_sub_button_count");
    ...
    public QTbl_caregiver_sub_button_count(String variable) {
        this(Tbl_caregiver_sub_button_count.class, forVariable(variable), INITS);
    }

    public QTbl_caregiver_sub_button_count(Path<? extends Tbl_caregiver_sub_button_count> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QTbl_caregiver_sub_button_count(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QTbl_caregiver_sub_button_count(PathMetadata metadata, PathInits inits) {
        this(Tbl_caregiver_sub_button_count.class, metadata, inits);
    }

    public QTbl_caregiver_sub_button_count(Class<? extends Tbl_caregiver_sub_button_count> type, PathMetadata metadata, PathInits inits) {
