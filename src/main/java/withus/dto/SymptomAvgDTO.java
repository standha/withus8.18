...
public class SymptomAvgDTO {
    ...
    public Integer getOutofbreath() {return outofbreath;}
    public Integer getTired() {return tired;}
    public Integer getAnkle() {return ankle;}
    public Integer getCough() {return cough;}
}
